...
#TODO: map each id to a measure, encoder, strain and force.
...
async def start_test():
    # TODO: Implement the logic to start a test
...
@app.post("/set_setpoint/{setpoint}")
async def set_setpoint(setpoint: float):
    machine.setpoint = setpoint
    return {"message": "Setpoint set"}

@app.post("/finish_test")
async def finish_test():
    # TODO: Implement the logic to finish a test
